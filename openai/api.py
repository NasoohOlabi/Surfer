...
first_prompt = start_conversation_with_post(alice,bob,demo_post)
chat.messages.append(Message(person=chat.correspondents[0],text=chat.askGPT(start_conversation_with_post(alice,bob,demo_post))))
